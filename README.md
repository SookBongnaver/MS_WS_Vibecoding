...
| 샘플 | 데이터 흐름 | 실행 |
|---|---|---|
| **공공데이터 시장 탐색 웹앱** | World Bank 공개 API → 로컬 SQLite 적재 → 연도·지표별 비교 | [실행 방법과 실제 화면](samples/public-data/README.md) |

### 상세 참고 — 필요한 경우만 열기

[설치·로그인](docs/setup.md) · [문제 해결](docs/troubleshooting.md) · [공식 자료](docs/sources.md)

**자료 상태:** 공공데이터 샘플에는 실제 실행 화면이 포함돼 있습니다. 코딩 도구별 제작 화면·Azure 구성 화면은 아직 미촬영입니다.
