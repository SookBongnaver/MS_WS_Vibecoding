...
**문서 역할:** 이 README는 참가자의 진행 안내, [docs/setup.md](docs/setup.md)는 사람용 환경 준비·접속·점검 절차, `starter/AGENTS.md`는 AI가 지킬 작업·승인·보고 규칙입니다. MS 운영 담당은 `starter` 프로젝트와 별도로 참가자에게 README와 환경 안내 링크를 제공합니다.
